    ...
    return (
        <div className='HomePageContainer'>
            <div className='home-page-header'>
                ...
                <h1 class="header">My name is Markiece Givens</h1>
            </div>
            ...
            <p className='home-page-body'>
                I started my college experience as a physics major and 
                during my junior year I began coding in my free time. I slowly became more and more
                fascinated with developing software or using code to automate certain tasks in my 
