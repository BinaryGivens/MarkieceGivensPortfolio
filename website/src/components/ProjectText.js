      ...
      <div className='project-list'>
        <ol type='I'>
          <li className='project-heading'> Autonomous Drone Simulation </li>
            <ul>
              <li className = 'project-body'> Summary: Drone flight simulation created in ROS2 with C++. </li>
              <li className = 'project-body'> Technologies: Utilizes ROS2, Python, C++ and Gazebo to control and plan flights of a drone
                  in a Gazebo Simulated world.
              </li>
              <li className = 'project-body'> Status: In progress </li>
            </ul>
            <li className='project-heading'> Ai Terminal Chess Game </li>
            <ul>
              <li className = 'project-body'> Summary: Terminal chess game where a player can play chess against Ai in a terminal.
              </li>
              <li className = 'project-body'> Technologies: This project is created in C++ and utilizes Heuristic to generate the best move possible. 
              </li>
              <li className = 'project-body'> Status: Basic chess rules are implemented but the Ai decision making is in progress </li>
            </ul>

          <li className='project-heading'> Portfolio Website </li>
            <ul>
              <li className = 'project-body'> Summary: This is the portfolio website for which you are currently looking at. It is
                your one stop shop to gettng an idea of who I am and what I have accomplished.
              </li>
              <li className = 'project-body'> Technologies: This website utilzies react and AWS (route53, Cloudfront, S3 and ACM) to
              ...
              <li className = 'project-body'> Status: Complete but updates regularly </li>
            </ul>
          </ol>
      </div>
      </>
